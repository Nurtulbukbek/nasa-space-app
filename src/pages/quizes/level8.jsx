...
function Level8() {
    ...
    const handleItemClick1 = () => setSelectedItem('Aeorosol');
            ...
            <div className="container">
                ...
                <div className="quizQuestion">
                    <div className="quizQuestions">
                        <h1 className="levelTitle">LEVEL 8</h1>
                        <div className="question">
                            <img className="questionPhoto" src="/aerosolLevel.png" alt="" />
                        ...
                        <div className="answers">
                                ...
                                style={{
                                        color: selectedItem === 'Aeorosol' ? 'green' : 'white',
                                        cursor: 'pointer',
                                        }}>
                                    Aeorosol
                                </div>
